# Archived README — original capstone state

This is the original README from when this example tree lived as
`examples/17-capstone` in `patterncatalyst/minikube-on-fedora`. It's
preserved here as audit trail; the active README is the file alongside
this one.
