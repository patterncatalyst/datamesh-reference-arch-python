...
[contracts & catalog page]({{ '/docs/04-contracts-and-catalog/' | relative_url }}).
...
[Kubernetes as the substrate]({{ '/docs/02-kubernetes-substrate/' | relative_url }})
...
[anti-pattern]({{ '/docs/09-anti-patterns/' | relative_url }}): the most
