...
The [previous page]({{ '/docs/01-concepts/' | relative_url }}) ended on a
...
strong enough that each principle has a natural home in Kubernetes primitives you
already know.
...
[data planes page]({{ '/docs/05-data-planes/' | relative_url }}) develops
...
[observability page]({{ '/docs/08-observability/' | relative_url }}).
