...
[concepts page]({{ '/docs/01-concepts/' | relative_url }}) frames each
...
[services page]({{ '/docs/03-services-and-data-products/' | relative_url }})
and [contracts page]({{ '/docs/04-contracts-and-catalog/' | relative_url }})
...
[progressive delivery & mTLS]({{ '/docs/06-progressive-delivery-mtls/' | relative_url }})
...
[data planes page]({{ '/docs/05-data-planes/' | relative_url }})
